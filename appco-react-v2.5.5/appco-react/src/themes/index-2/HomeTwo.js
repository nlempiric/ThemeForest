...
export default function HomeTwo(props) {
  const [Idea, setIdeas] = useState(false);
  return (
    <Layout>
      <Navbar darkBg />
      <HeroTwo Idea={Idea} setIdeas={setIdeas}/>
      
      {Idea ? <Ideas articleAraay={props.articleAraay} setarticleAraay={props.setarticleAraay}/>  : null }
      <PromoTwo />
      <AboutApp />
