...
import UserComp from "../components/UserComponent/UserComp";
import { useState } from "react";

const AppRoutes = () => {
  const [articleAraay, setarticleAraay] = useState([]);

  return (
    <>
      <ScrollToTop />
      <Routes>
        <Route path="/" element={<HomeTwo articleAraay={articleAraay} setarticleAraay={setarticleAraay}/>} />
        <Route path="/article" element={<ArticlePageComponent articleAraay={articleAraay}/>} />
